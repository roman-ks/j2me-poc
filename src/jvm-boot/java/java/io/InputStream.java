...
// Change from original Android libcore file:
// - remove libcore.io.Streams dependency
package java.io;
/**
...
public abstract class InputStream extends Object implements Closeable {
    ...
    public long skip(long byteCount) throws IOException {
        ...
        byte[] buffer = new byte[(int) Math.min(2048, byteCount)];
        long totalBytesSkipped = 0;
        while (totalBytesSkipped < byteCount) {
            int bytesToRead = (int) Math.min(buffer.length, byteCount - totalBytesSkipped);
